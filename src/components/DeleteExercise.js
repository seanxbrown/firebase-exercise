...
const DeleteExercise = ({selectedExercise, closeExerciseDeletionBox, removeExerciseFromWorkout}) => {
  ...
  return (
    <Container className="bg-danger bg-gradient border border-1 border-white rounded p-4 w-50 position-absolute top-50 start-50 translate-middle" id="deleteExerciseBox">
